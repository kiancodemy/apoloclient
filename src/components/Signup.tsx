...
import useSignup from "../hook/singup";
...
export default function Signup() {
  ...
  useEffect(() => {
    if (error) {
      ...
      showToast("sucessfully signed up", "success");
      setTimeout(() => {
        navigate("/signin");
      }, 1000);
    }
  ...
  return (
    <div className="container py-5 flex justify-center items-center grow">
      ...
      >
        <h1 className="text-3xl mb-5 font-semibold capitalize">singup</h1>
        ...
        <div className="flex items-center capitalize gap-x-3">
          ...
          <button
            className="py-1 px-5 capitalize bg-yellow-500 text-white rounded-md"
            disabled={loading}
          >
